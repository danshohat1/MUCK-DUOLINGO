...
function EditAccount() {
  ...
  const deleteAccount = () => {
    ...
    axios.delete("http://10.0.0.45:8003/update_user?username=" + sessionStorage.getItem("username")).then((data) => {
  ...
  const handleVerificationSubmit = async () => {
    ...
    if (currentTab === 0) {
      ...
      if (verificationInput === "SUBMIT") {
        ...
        axios.put(`http://10.0.0.45:8003/update_user?oldUsername=${sessionStorage.getItem("username")}&username=${sessionStorage.getItem("username")}&newPassword=${newPassword}`).then((data)=>{
      ...
      if (verificationInput === "SUBMIT") {
        console.log("here!!@@")
        await axios.put(`http://10.0.0.45:8003/update_user?oldUsername=${sessionStorage.getItem("username")}&username=${newUsername}`).then((data)=>{
          console.log("here1!!!!")
          setVerificationOpen(false);
