...
class Route:
    ...
    def __init__(self, func, method: HttpMethod=HttpMethod.GET,
                 path: str="/",
                 authorization: Optional[Authorization]=None) -> None:
        """
        Initialize a new Route insatance.

        Parameters:
        - method (HttpMethod): The HTTP method associated with the
         route (default is GET).
