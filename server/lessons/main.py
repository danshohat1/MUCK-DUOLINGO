...
class Lesson:
    def __init__(self, level: int, lang: str):
        ...
        """
            ...
            self.level_data["questions"][index]['question'] =
            Lesson.check(question["question"], self.lang)
            self.level_data["questions"][index]['answer'] =
            Lesson.check(question["answer"], self.lang)
        """
    ...
    def check(st: str, lang):
        ...
        for word in re.findall(pattern, st):
            if word == "LANG":
                ...
                words.append(
                    (word, translator.translate(word.replace("_", " "))))
