...
class MultipleChoice(ABC):
    ...
    def __init__(self, answer:str, number_of_options: int, words: List[Dict[str, str]])  -> None:
        self.answer = answer 
    ...
    def generate_options(self) -> List[str]:
        ...
        options = random.sample(translations, self.number_of_options - 1) + [self.answer]
